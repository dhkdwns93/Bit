...
public class BoardDAOimpl implements BoardDAO {
	...
	public int insertOne(ReviewDTO reviewDTO) throws SQLException {
		...
		try {
			...
			pstmt = conn.prepareStatement(resourceBundle.getString("query.insertOne"));
			...
			//insert into review values (seq_re_id.nextval,?,?, (select user_id from users where user_id=?),?, ?, ?);
