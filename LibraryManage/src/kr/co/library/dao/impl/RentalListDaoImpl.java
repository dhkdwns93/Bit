...
public class RentalListDaoImpl implements RentalListDao {
	...
	@Override
	public List<RentalList> selectRentalListPagingByEndIsNull(SqlSession session, String userId, int startIndex, int endIndex) {
		// TODO Auto-generated method stub
		Map<String, String> input = new HashMap<String, String>();
	...
	public int selectRentalListByEndIsNullCountByUserId(SqlSession session, String userId) {
		return session.selectOne(namespace+"selectRentalListByEndIsNullCountByUserId",userId);
	}
