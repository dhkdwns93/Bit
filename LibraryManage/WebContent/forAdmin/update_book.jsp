...
<body>
<c:if test="${sessionScope.updateBookMessage != null}">
	<script>alert('${sessionScope.updateBookMessage}')</script>
	<c:remove scope="session" var="updateBookMessage"/>
	</c:if>
<header>
	<h1>도서정보관리</h1>
</header>
<aside>
    ...
    <li><a href="update_book.jsp"><h2>도서수정</h2></a></li>
    <li><a href="delete_book.jsp"><h3>도서삭제</h3></a></li>
  </ul>
</aside> 
<article>
	<form action="/LibraryManage/updateBook" method = "post">
	<br>
	<h2 class="center">도서수정</h2>
      <div align="center">
         <table>
            <tr>
               <td>책ID</td>
            ...
            <tr>
               <td>대출가능상태</td>
               <td><input type ="text"  name = "rentalState"></td>
            </tr>
            <tr>
            	<td></td>
